          ...
          <div className="md:w-[70%] w-[80%] mx-auto ">
            <div className="flex flex-col md:flex-row md:justify-between justify-center  gap-4 mb-10">
              <div className="md:w-1/2 w-full">
                <h1 className="md:text-3xl text-2xl font-bold mb-2 text-center md:text-left text-orange-500 merienda">
                  Get in Touch
                </h1>
              ...
              <div className="space-y-6 ">
                <form>
                  <h6 className="md:text-2xl font-semibold text-xl text-center md:text-left text-orange-500 merienda">
                    Newsletter
                  </h6>
            ...
            <div>
              ...
              <div>
                <nav className="w-2/3 mx-auto flex  items-center justify-center gap-10 text-orange-500 text-xl">
              ...
              <div>
                <nav className="w-2/3 mx-auto flex flex-col items-center md:flex-row justify-between gap-2 text-orange-500">
            ...
            <div className="flex flex-col-reverse items-center gap-2 md:flex-row justify-between">
              <p className="text-gray-600">
                All rights reserved@
                <span className="font-bold text-orange-500">2024</span>{" "}
              </p>
